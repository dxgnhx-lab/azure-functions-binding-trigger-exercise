...
@app.event_hub_message_trigger(arg_name="azeventhub", event_hub_name="test-hub",
                               connection="d2t001eventhub_RootManageSharedAccessKey_EVENTHUB") 
...
def eventhub_output(req: func.HttpRequest, event: func.Out[str]) -> func.HttpResponse:
    ...
    return func.HttpResponse("Event Hub output function executed successfully.")
...
#     arg_name="event", event_hub_name="test-hub", connection="d2t001eventhub_RootManageSharedAccessKey_EVENTHUB"
# )
